...
/// The dataset this demo opens when it is given nothing else — Crambin (PDB 1CRN): 46 residues, the classic small protein.
...
pub const sample_name = "1crn.pdb";
pub const sample: []const u8 = @embedFile("sample.pdb");
